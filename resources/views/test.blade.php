...
<!-- Mirrored from warehouse-admin-dashboard.multipurposethemes.com/main-horizontal-dark/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Dec 2021 23:44:39 GMT -->
<head>
    <meta charset="utf-8">
			...
			<div class="row">
				...
				<div class="col-xl-3 col-lg-6 col-12">
					<div class="box">
						<div class="box-body">
							<div class="d-flex justify-content-between">
								<h2 class="my-0 fw-600 text-info">$ 532k</h2>
							...
							<div class="inner-user-div3">
								...
								<div class="box-shadowed p-10 mb-10 rounded10">
									<div class="d-flex justify-content-between align-items-center">
										...
										<div>
											...
											<p class="mb-0"><span>$140 per unit</span> | <strong>$37,200</strong></p>
										</div>
									</div>
								</div>
								<div class="box-shadowed p-10 mb-10 rounded10">
								...
								<div class="box-shadowed p-10 mb-10 rounded10">
									<div class="d-flex justify-content-between align-items-center">
										...
										<div>
											<h3 class="my-5">98 Units</h3>
											<p class="mb-0"><span>$100 per unit</span> | <strong>$17,200</strong></p>
										</div>
									</div>
								</div>
								<div class="box-shadowed p-10 mb-10 rounded10">
